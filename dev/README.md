...
* [Conversion Utility](./tools/README.md) - standardized approach for creating an official API Specificiation file by taking Ed-Fi API output, removing Change Queries, converting to YAML, and streamlining the file size.
* [Manual notes: Converting Swagger 2 to Open API 3](./FROM-SWAGGER-TO-OPENAPI.md)
